 ...
 * Original file: /npm/swiper@11.2.8/swiper.mjs
 *
...
function t(s, i) {
    ...
    Object.keys(i).filter((e => r.indexOf(e) < 0)).forEach((r => {
...
function l(e, t) {
    ...
    return s.WebKitCSSMatrix ? (r = o.transform || o.webkitTransform,
    r.split(",").length > 6 && (r = r.split(", ").map((e => e.replace(",", "."))).join(", ")),
    a = new s.WebKitCSSMatrix("none" === r ? "" : r)) : (a = o.MozTransform || o.OTransform || o.MsTransform || o.msTransform || o.transform || o.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"),
    i = a.toString().split(",")),
    ...
    for (let i = 1; i < arguments.length; i += 1) {
        ...
        !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
            ...
            for (let t = 0, i = s.length; t < i; t += 1) {
                ...
                void 0 !== n && n.enumerable && (d(e[i]) && d(r[i]) ? r[i].__swiper__ ? e[i] = r[i] : c(e[i], r[i]) : !d(e[i]) && d(r[i]) ? (e[i] = {},
                r[i].__swiper__ ? e[i] = r[i] : c(e[i], r[i])) : e[i] = r[i])
            }
        }
    }
    var s;
...
function y(e) {
    ...
    T || (T = function(e) {
        ...
        const u = a.match(/(iPod)(.*OS\s([\d_]+))?/)
          ...
          , h = "Win32" === r;
        let m = "MacIntel" === r;
        return !p && m && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${d}`) >= 0 && (p = a.match(/(Version)\/([\d.]+)/),
        p || (p = [0, 1, "13_0_0"]),
        m = !1),
        c && !h && (o.os = "android",
        o.android = !0),
...
var O = {
    ...
    updateSlides: function() {
        ...
        for (let i = 0; i < u; i += 1) {
            ...
            !c[i] || "none" !== v(r, "display")) {
                ...
                g.push(I),
                s.centeredSlides ? (E = E + I / 2 + M / 2 + y,
                0 === M && 0 !== i && (E = E - n / 2 - y),
                0 === i && (E = E - n / 2 - y),
                Math.abs(E) < .001 && (E = 0),
                s.roundLengths && (E = Math.floor(E)),
                P % s.slidesPerGroup == 0 && h.push(E),
                m.push(E)) : (s.roundLengths && (E = Math.floor(E)),
                (P - Math.min(e.params.slidesPerGroupSkip, P)) % e.params.slidesPerGroup == 0 && h.push(E),
                m.push(E),
                E = E + I + y),
                e.virtualSize += I + y,
                M = I,
        ...
        if (e.virtualSize = Math.max(e.virtualSize, n) + T,
        a && o && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize + y}px`),
        s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = `${e.virtualSize + y}px`),
        C && e.grid.updateWrapperSize(I, h),
        !s.centeredSlides) {
            const t = [];
    ...
    updateSlidesProgress: function(e) {
        ...
        for (let e = 0; e < i.length; e += 1) {
            ...
            P(l, h, s.slideFullyVisibleClass),
            l.progress = r ? -c : c,
    ...
    updateSlidesClasses: function() {
        ...
        if (n)
            ...
            a ? (l = t.find((e => e.column === r)),
            c = t.find((e => e.column === r + 1)),
            d = t.find((e => e.column === r - 1))) : l = t[r];
        l && (a || (c = function(e, t) {
            const s = [];
...
function z(e) {
    ...
    t.emit(`transition${r}`),
    s && "reset" === o ? t.emit(`slideResetTransition${r}`) : s && n !== a && (t.emit(`slideChangeTransition${r}`),
...
var G = {
    slideTo: function(e, t, s, i, r) {
        ...
        let a = e;
        a < 0 && (a = 0);
        const {params: o, snapGrid: l, slidesGrid: d, previousIndex: c, activeIndex: p, rtlTranslate: f, wrapperEl: h, enabled: m} = n;
        if (!m && !i && !r || n.destroyed || n.animating && o.preventInteractionOnTransition)
            return !1;
        ...
        if (n.initialized && a !== p) {
            if (!n.allowSlideNext && (f ? w > n.translate && w > n.minTranslate() : w < n.translate && w < n.minTranslate()))
                return !1;
            if (!n.allowSlidePrev && w > n.translate && w > n.maxTranslate() && (p || 0) !== a)
                return !1
        }
        let S;
        ...
        const b = E().isSafari;
        return T && !r && b && n.isElement && n.virtual.update(!1, !1, a),
        n.setTransition(t),
        n.setTranslate(w),
        ...
        0 === t ? n.transitionEnd(s, S) : n.animating || (n.animating = !0,
    ...
    slideToClickedSlide: function() {
        ...
        if (t.loop) {
            ...
            n = e.getSlideIndex(f(s, `${o}[data-swiper-slide-index="${r}"]`)[0]),
            a(( () => {
                e.slideTo(n)
            }
...
var _ = {
    ...
    loopFix: function(e) {
        ...
        const {slides: c, allowSlidePrev: p, allowSlideNext: u, slidesEl: f, params: m} = d
          , {centeredSlides: v, initialSlide: g} = m;
        if (d.allowSlidePrev = !0,
        d.allowSlideNext = !0,
        d.virtual && m.virtual.enabled)
            return s && (m.centeredSlides || 0 !== d.snapIndex ? m.centeredSlides && d.snapIndex < m.slidesPerView ? d.slideTo(d.virtual.slides.length + d.snapIndex, 0, !1, !0) : d.snapIndex === d.snapGrid.length - 1 && d.slideTo(d.virtual.slidesBefore, 0, !1, !0) : d.slideTo(d.virtual.slides.length, 0, !1, !0)),
            d.allowSlidePrev = p,
            d.allowSlideNext = u,
            void d.emit("loopFix");
        let w = m.slidesPerView;
        "auto" === w ? w = d.slidesPerViewDynamic() : (w = Math.ceil(parseFloat(m.slidesPerView, 10)),
        v && w % 2 == 0 && (w += 1));
        ...
        c.length < w + T || "cards" === d.params.effect && c.length < w + 2 * T ? h("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : b && "row" === m.grid.fill && h("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
        const x = []
          , y = []
        ...
        let L = 0
          , k = 0;
        const O = (b ? c[n].column : n) + (v && void 0 === r ? -w / 2 + .5 : 0);
        if (O < T) {
            L = Math.max(T - O, S);
        ...
        "cards" === d.params.effect && c.length < w + 2 * T && (y.includes(n) && y.splice(y.indexOf(n), 1),
        ...
        d.recalcSlides(),
        "auto" === m.slidesPerView ? d.updateSlides() : b && (x.length > 0 && I || y.length > 0 && C) && d.slides.forEach(( (e, t) => {
        ...
        s)
            if (x.length > 0 && I) {
                if (void 0 === t) {
                    ...
                    l ? d.setTranslate(d.translate - t) : (d.slideTo(P + Math.ceil(L), 0, !1, !0),
                ...
                if (void 0 === t) {
                    ...
                    l ? d.setTranslate(d.translate - t) : (d.slideTo(P - k, 0, !1, !0),
                    r && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t,
                    d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t))
                } else {
...
function D(e, t, s) {
    ...
    return !a || !(s <= o || s >= i.innerWidth - o) || "prevent" === a && (t.preventDefault(),
    !0)
}
function V(e) {
    const t = this
    ...
    if ("touchstart" === r.type)
        return void D(t, r, r.targetTouches[0].pageX);
    ...
    u && r.target && r.target.shadowRoot && f && (p = f[0]);
    ...
    !l.touchStartForcePreventDefault && !S || p.isContentEditable || r.preventDefault(),
...
function B(e) {
    ...
    if ("touchmove" === p.type) {
        if (c = [...p.changedTouches].find((e => e.identifier === r.touchId)),
    ...
    if (n.touchReleaseOnEdges && !n.loop)
        if (s.isVertical()) {
            if (f < a.startY && s.translate <= s.maxTranslate() || f > a.startY && s.translate >= s.minTranslate())
    ...
    if (t.activeElement && t.activeElement.matches(r.focusableElements) && t.activeElement !== p.target && "mouse" !== p.pointerType && t.activeElement.blur(),
    ...
    if (void 0 === r.isScrolling) {
        let e;
        s.isHorizontal() && a.currentY === a.startY || s.isVertical() && a.currentX === a.startX ? r.isScrolling = !1 : h * h + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(h)) / Math.PI,
    ...
    n.oneWayMovement && (v = Math.abs(v) * (l ? 1 : -1),
    g = Math.abs(g) * (l ? 1 : -1)),
    a.diff = v,
    v *= n.touchRatio,
    l && (v = -v,
    ...
    if ((new Date).getTime(),
    !1 !== n._loopSwapReset && r.isMoved && r.allowThresholdMove && w !== s.touchesDirection && S && T && Math.abs(v) >= 1)
    ...
    v > 0 ? (S && T && r.allowThresholdMove && r.currentTranslate > (n.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] - ("auto" !== n.slidesPerView && s.slides.length - n.slidesPerView >= 2 ? s.slidesSizesGrid[s.activeIndex + 1] + s.params.spaceBetween : 0) - s.params.spaceBetween : s.minTranslate()) && s.loopFix({
        direction: "prev",
        setTranslate: !0,
        activeSlideIndex: 0
    }),
    r.currentTranslate > s.minTranslate() && (b = !1,
    n.resistance && (r.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + r.startTranslate + v) ** x))) : v < 0 && (S && T && r.allowThresholdMove && r.currentTranslate < (n.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] + s.params.spaceBetween + ("auto" !== n.slidesPerView && s.slides.length - n.slidesPerView >= 2 ? s.slidesSizesGrid[s.slidesSizesGrid.length - 1] + s.params.spaceBetween : 0) : s.maxTranslate()) && s.loopFix({
        direction: "next",
        setTranslate: !0,
        activeSlideIndex: s.slides.length - ("auto" === n.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(n.slidesPerView, 10)))
    }),
    r.currentTranslate < s.maxTranslate() && (b = !1,
    n.resistance && (r.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - r.startTranslate - v) ** x))),
...
function N(e) {
    ...
    if ("touchend" === r.type || "touchcancel" === r.type) {
        if (i = [...r.changedTouches].find((e => e.identifier === s.touchId)),
    ...
    if (t.allowClick) {
        ...
        t.emit("tap click", r),
        f < 300 && u - s.lastClickTime < 300 && t.emit("doubleTap doubleClick", r)
    }
    ...
    s.isMoved = !1,
    s.startMoving = !1,
    h = n.followFinger ? d ? t.translate : -t.translate : -s.currentTranslate,
    n.cssMode)
        return;
    ...
    for (let e = 0; e < c.length; e += e < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
        ...
        void 0 !== c[e + t] ? (m || h >= c[e] && h < c[e + t]) && (v = e,
        g = c[e + t] - c[e]) : (m || h >= c[e]) && (v = e,
    ...
    if (f > n.longSwipesMs) {
        ...
        "next" === t.swipeDirection && (T >= n.longSwipesRatio ? t.slideTo(n.rewind && t.isEnd ? w : v + b) : t.slideTo(v)),
        "prev" === t.swipeDirection && (T > 1 - n.longSwipesRatio ? t.slideTo(v + b) : null !== S && T < 0 && Math.abs(T) > n.longSwipesRatio ? t.slideTo(S) : t.slideTo(v))
    } else {
        if (!n.shortSwipes)
            return void t.slideTo(t.activeIndex);
        t.navigation && (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl) ? r.target === t.navigation.nextEl ? t.slideTo(v + b) : t.slideTo(v) : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : v + b),
...
const W = (e, t) => {
    ...
    r.updateOnWindowResize ? e[c](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", F, !0) : e[c]("observerUpdate", F, !0),
    n[d]("load", e.onLoad, {
        capture: !0
    }))
}
    ...
    breakpoints: {
        setBreakpoint: function() {
            ...
            const u = (p in a ? a[p] : void 0) || e.originalParams
              ...
              , v = u.grabCursor
              , g = r.enabled;
            f && !h ? (n.classList.remove(`${r.containerModifierClass}grid`, `${r.containerModifierClass}grid-column`),
            e.emitContainerClasses()) : !f && h && (n.classList.add(`${r.containerModifierClass}grid`),
            (u.grid.fill && "column" === u.grid.fill || !u.grid.fill && "column" === r.grid.fill) && n.classList.add(`${r.containerModifierClass}grid-column`),
            ...
            s && (S ? (e.loopDestroy(),
            e.loopCreate(t),
            e.updateSlides()) : !T && x ? (e.loopCreate(t),
            e.updateSlides()) : T && !x && e.loopDestroy()),
            e.emit("breakpoint", u)
        },
...
//# sourceMappingURL=/sm/6587f84be1ebce7af73fc50479811a58ba30854c7dd48f6234aab8142f0c282f.map
